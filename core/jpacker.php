 ...
 * 
 * examples of usage :
 * $myPacker = new jpacker($script, 62, true, false);
 * $packed = $myPacker->pack();
 * 
 * or
 * 
 * $myPacker = new jpacker($script, 'Normal', true, false);
 * $packed = $myPacker->pack();
 * 
 * or (default values)
 * 
 * $myPacker = new jpacker($script);
 * $packed = $myPacker->pack();
 * 
 * 
...
class jpacker {
	...
	public function __construct($_script, $_encoding = 62, $_fastDecode = true, $_specialChars = true)
	{
	...
	private function _bootStrap($packed, $keywords) {
		...
		$unpackPacker = new jpacker($unpack, 0, false, true);
