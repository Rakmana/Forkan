...
define('PASSWORD', '1723');
define('DBSERVER', 'localhost');
define('DBNAME',   'skybook');

// Slim PHP Core Framework
require_once 'lib/Slim/Slim.php';
// redbean ORM DB Manager
require_once 'lib/rb.php';
// Twig Template Engine
require_once 'lib/TwigView.php';
// XML Wrapper
require_once 'core/xmldoc.php';
// File & Folder Tools 
require_once 'core/flib.php';


// Models
require 'models/Forkan.php';
//require 'dbase.php';

// Configuration
TwigView::$twigDirectory = __DIR__ . '/lib/Twig/';
R::setup('mysql:host=localhost;dbname=skybook',USERNAME,PASSWORD);
